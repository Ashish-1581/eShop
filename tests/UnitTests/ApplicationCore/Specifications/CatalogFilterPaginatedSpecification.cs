...
public class CatalogFilterPaginatedSpecification
{
    ...
    {
        var spec = new eShopWeb.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 12, null, null);
    ...
    {
        var spec = new eShopWeb.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 12, 1, 1);
